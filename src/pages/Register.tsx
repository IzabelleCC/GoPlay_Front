    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: colors.white }} contentContainerStyle={{ paddingBottom: 30 }}>
            <VStack flex={1} p={5} space={5} alignItems="center">
                ...
                <Text fontSize={fontSizes.lg} mb={4}>Dados Pessoais</Text>

                <FormControl w="100%">
                    <FormControl.Label>Seu Perfil (login)</FormControl.Label>
                    <Input onChangeText={(v) => handleInput("userName", v)} />
                ...
                <FormControl w="100%">
                    ...
                    <Input onChangeText={(v) => handleInput("name", v)} />
                </FormControl>

                <FormControl w="100%">
                    <FormControl.Label>E-mail</FormControl.Label>
                    <Input keyboardType="email-address" onChangeText={(v) => handleInput("email", v)} />
                </FormControl>

                <FormControl w="100%">
                    <FormControl.Label>CPF ou CNPJ</FormControl.Label>
                    <Input keyboardType="numeric" onChangeText={(v) => handleInput("cpfCnpj", v)} />
                </FormControl>
                ...
                <FormControl w="100%">
                    ...
                    <Input onChangeText={(v) => handleInput("instagramPage", v)} />
                </FormControl>
